package trabalhoComDatas.tarefa1.application;
...
public class Program {
    public static void main(String[] args) throws ParseException {
        ...
        Date y1 = sdf1.parse("10/05/2002");
        Date y2 = sdf2.parse("10/05/2002 07:35:18");

        Date x1 = new Date();
        Date x2 = new Date(System.currentTimeMillis());
        Date x3 = new Date(0L);
        Date x4 = new Date(1000L * 60L * 60L * 5L );
        Date y3 = Date.from(Instant.parse("2002-05-10T07:30:00Z"));
